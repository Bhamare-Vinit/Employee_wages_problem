...
@Title : To find the monthly wages of employees till a condition of total working hours or days is reached 
'''
PER_HR_WAGE=20
def employee_monthly_wage ():
    """
    Description: function is used to find the monthly wages of employees till a condition of total working hours or days is reached
    Parameter:None
